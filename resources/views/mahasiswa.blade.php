    ...
    <div class="container">
        ...
        <main class="content">
            ...
            <div class="avia_textblock" itemprop="text">
                <h1 class="heading"><strong>AKTIVITAS KEMAHASISWAAN
                </strong></h1>
                <p>Untuk menambah pengalaman dalam bekerja secara tim, mahasiswa bisa mengikuti beberapa organisasi mahasiswa baik di lingkungan program studi, fakultas, maupun universitas. Terdapat dua wadah belajar keorganisasian di tingkat jurusan, yakni: himpunan mahasiswa teknologi Informasi (HMJTI), Asisten Laboratorium, dan Google Developer Student Club (GDSC) UIN Walisongo</p>

                <br>
                <h3 class="heading"><strong>HMJTI
                </strong></h3>
                <p>Himpunan Mahasiswa Jurusan Teknologi Informasi (HMJTI) UIN Walisongo, merupakan organisasi mahasiswa resmi dibawah naungan Prodi Teknologi Informasi. HMJTI beranggotakan mahasiswa prodi TI. Kegiatan HMJTI dapat dilihat pada link <a style="color: yellow" href="https://www.ti-crew.my.id/">https://www.ti-crew.my.id/</a>.</p>

                <br>
                <h3 class="heading"><strong>ASISTEN TENAGA KERJA

                </strong></h3>
                <p>Asisten laboratorium merupakan mahasiswa pilihan dari Prodi Teknologi Informasi yang bertugas membantu pengelolaan Laboratorium dan juga membantu dosen dalam proses belajar mengajar di laboratorium.</p>
                <br>
                <h3 class="heading"><strong>GDSC UIN WALISONGO

                </strong></h3>
                <p>Google Developer Student Club UIN Walisongo merupakan komunitas yang didukung oleh Google Developers. Kami belajar dan bertumbuh bersama untuk memecahkan masalah lokal dengan teknologi. GDSC UIN Walisongo terbuka bagi mahasiswa UIN Walisongo yang tertarik dengan teknologi. Buka tautan di bawah ini, untuk informasi lebih lanjut tentang GDSC <a style="color: yellow" href="https://gdsc.community.dev/uin-walisongo-semarang-indonesia/">https://gdsc.community.dev/uin-walisongo-semarang-indonesia/</a>.</p>
                                ...
                                <div class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1506588382366 vc_row-has-fill">
                                    <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-has-fill">
                                        <div class="vc_column-inner vc_custom_1513230473731">
                                            <div class="wpb_wrapper">
                                                <h2 style="font-size: 18px;text-align: left;font-family:Montserrat;font-weight:700;font-style:normal" class="vc_custom_heading">AKTIVITAS KEGIATAN MAHASISWA</h2>
