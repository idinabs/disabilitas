        ...
        <main class="content">
            ...
            <article class="news-detail">
                <div class="news-image">
                    @if ($news->image)
                        <img src="{{ asset('storage/' . $news->image) }}" alt="Gambar Berita Utama">
                    @endif
                </div>
                <h2 class="news-title">{{ $news->title }}</h2>
                <p class="news-meta">Diterbitkan pada: <span class="news-date">{{ $news->created_at->format('d M Y') }}</span></p>
                
                <div class="news-content">
                    {!! $news->content !!} <!-- Menampilkan konten berita dengan HTML yang dihasilkan oleh CKEditor -->
                </div>
                <a href="#" class="back-link">Kembali ke Berita</a>
            </article>
                ...
                <ul>
                    <li>
                        ...
                        @if ($item->image)
                            ...
                            <img src="{{ asset('storage/' . $item->image) }}" alt="Thumbnail Berita 1">
                        @endif
